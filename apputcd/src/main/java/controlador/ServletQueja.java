...
public class ServletQueja extends HttpServlet {
	...
	private void registrar(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException {
		...
		Queja queja = new Queja(0, request.getParameter("nombre"), request.getParameter("apellido"), request.getParameter("telefono"), request.getParameter("departamento"), request.getParameter("ciudad"), request.getParameter("barrio"), request.getParameter("direccion"), request.getParameter("correo"), request.getParameter("referencia"));
	...
	private void editar(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException  {
		...
		Queja queja = new Queja(Integer.parseInt(request.getParameter("id_reclamo")), request.getParameter("nombre"), request.getParameter("apellido"), request.getParameter("telefono"), request.getParameter("departamento"), request.getParameter("ciudad"), request.getParameter("barrio"), request.getParameter("direccion"), request.getParameter("correo"), request.getParameter("referencia"));
